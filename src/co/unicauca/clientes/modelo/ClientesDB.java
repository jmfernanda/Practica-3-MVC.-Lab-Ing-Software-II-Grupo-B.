...
public class ClientesDB extends java.util.Observable {
    ...
    //Metodo para hallar el porcentaje de hombre y mujeres por profesion
    public float porcentajeMujeres(){
        return (float)(totalMujeres*100)/(clientesPorProfesion.size());
    }
    public float porcentajeHombres(){
        return((float)(totalHombres*100)/clientesPorProfesion.size()); 
    }
}
